...
const Footer = () => {
  return (
    <div>
      <footer className="bg-neutral-950 py-14 border-t border-neutral-800">
        <div className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div className="max-w-3xl mx-auto">
                <div className="text-center text-4xl font-semibold text-neutral-200">
                  <span className="flex md:flex-row flex-col items-center justify-center gap-2">
                    <Coffeemug loop={true} />
                    <span className="text-amber-500">Get Me a Chai</span>
                  </span>
                </div>
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-neutral-800">
                        <li><a href="/about" className="text-neutral-400 hover:text-amber-500 transition-colors">About</a></li>
                        <li><a href="/contact" className=" text-neutral-400 hover:text-amber-500 transition-colors">Contact us</a></li>
                        <li><a href="/services" className=" text-neutral-400 hover:text-amber-500 transition-colors">Services</a></li>
                        <li><a href="/blogs" className=" text-neutral-400 hover:text-amber-500 transition-colors">Blogs</a></li>
                        <li><a href="/support" className=" text-neutral-400 hover:text-amber-500 transition-colors">Support</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="#" className="block text-neutral-400 transition-all duration-300 hover:text-amber-500 hover:scale-110">
                          <svg className="w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none">
                        ...
                        <a href="#" className="block text-neutral-400 transition-all duration-300 hover:text-amber-500 hover:scale-110">
                            <svg className="w-7 h-7" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" className="block text-neutral-400 transition-all duration-300 hover:text-amber-500 hover:scale-110">
                            <svg className="w-4 h-7" viewBox="0 0 15 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" className="block text-neutral-400 transition-all duration-300 hover:text-amber-500 hover:scale-110">
                            <svg className="w-8 h-6" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-sm text-neutral-500 text-center block">©<a href="#">getmeachai</a> 2025, All rights reserved.</span>
