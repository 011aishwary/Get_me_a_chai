            ...
            <div className="max-w-3xl mx-auto">
                ...
                Get Me a Chai
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        ...
                        <li><a href="/contact" className=" text-[#f2f2ef] hover:text-[#c2a991]">contact us</a></li>
                        <li><a href="/services" className=" text-[#f2f2ef] hover:text-[#c2a991]">Services</a></li>
                        <li><a href="/blogs" className=" text-[#f2f2ef] hover:text-[#c2a991]">Blogs</a></li>
                        <li><a href="/support" className=" text-[#f2f2ef] hover:text-[#c2a991]">Support</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="#" className="block  text-[#f2f2ef]transition-all duration-500 hover:text-indigo-600 ">
                    ...
                    <span className="text-lg text-[#f2f2ef] text-center block">©<a href="#">getmeachai</a> 2025, All rights reserved.</span>
            </div>
        </div>
    </footer>
    </div>
